...
-keep class my.noveldokusha.text_translator.TranslationManagerGooglePA { *; }
-keep class my.noveldokusha.text_translator.TranslationManagerOpenAI { *; }
-keep class my.noveldokusha.text_translator.domain.** { *; }
...
-keep class my.noveldokusha.feature.local_database.** { *; }
