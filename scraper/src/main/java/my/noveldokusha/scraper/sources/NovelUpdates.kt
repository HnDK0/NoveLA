// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/NovelUpdates.kt).
// This is the SOURCE variant of NovelUpdates — distinct from the NovelUpdates
// database class in scraper/databases/. There is no Lua plugin duplicate.
