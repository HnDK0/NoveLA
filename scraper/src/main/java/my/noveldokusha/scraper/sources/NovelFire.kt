// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/NovelFire.kt).
// The NovelFire source has a Lua plugin duplicate in external-sources/en/novelfire.lua,
// so its display name is suffixed "(Paras)" via source_name_novelfire.
