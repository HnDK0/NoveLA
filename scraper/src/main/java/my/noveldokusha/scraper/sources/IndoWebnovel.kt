// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/IndoWebnovel.kt).
// The IndoWebnovel source has a Lua plugin duplicate in external-sources/id/indowebnovel.lua,
// so its display name is suffixed "(Paras)" via source_name_indo_webnovel.
