// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/NovelHall.kt).
// The NovelHall source has a Lua plugin duplicate in external-sources/en/novelhall.lua,
// so its display name is suffixed "(Paras)" via source_name_novelhall.
