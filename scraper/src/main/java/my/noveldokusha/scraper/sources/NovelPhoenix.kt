// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/NovelPhoenix.kt).
// The NovelPhoenix source has a Lua plugin duplicate in external-sources/en/novelphoenix.lua,
// so its display name is suffixed "(Paras)" via source_name_novel_phoenix.
