// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/MeioNovel.kt).
// The MeioNovel source has a Lua plugin duplicate in external-sources/id/meionovels.lua,
// so its display name is suffixed "(Paras)" via source_name_meio_novel.
