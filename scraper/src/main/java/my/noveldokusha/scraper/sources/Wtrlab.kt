// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/Wtrlab.kt).
// The Wtrlab source has a Lua plugin duplicate in external-sources/mtl/wtrlab.lua,
// so its display name is suffixed "(Paras)" via source_name_wtrlab.
