// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/BacaLightnovel.kt).
// The BacaLightnovel source has a Lua plugin duplicate in external-sources/id/bacalightnovel.lua,
// so its display name is suffixed "(Paras)" via source_name_baca_lightnovel.
