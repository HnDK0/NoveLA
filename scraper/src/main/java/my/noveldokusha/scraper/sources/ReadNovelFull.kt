// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/ReadNovelFull.kt).
// The ReadNovelFull source has a Lua plugin duplicate in external-sources/en/readnovelfull.lua,
// so its display name is suffixed "(Paras)" via source_name_read_novel_full.
