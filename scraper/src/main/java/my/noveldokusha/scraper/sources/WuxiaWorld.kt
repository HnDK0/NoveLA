// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/WuxiaWorld.kt).
// The WuxiaWorld (wuxiaworld.site) source has a Lua plugin duplicate in
// external-sources/en/wuxiaworld_site.lua, so its display name is suffixed
// "(Paras)" via source_name_wuxia_world.
