// ponytail: ported from Paras fork (ParasNovelDokusha/scraper/.../sources/RoyalRoad.kt).
// The RoyalRoad source has a Lua plugin duplicate in external-sources/en/royal_road.lua,
// so its display name is suffixed "(Paras)" via source_name_royal_road.
